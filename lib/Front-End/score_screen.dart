                    ...
                    child: BackdropFilter(
                      ...
                      child: Container(
                        ...
                        child: ExpandableProgressBar(tempIcon,
                            FeedbackMessage.getTempMessage(temp), temp),
                      ),
                    ),
                  ),
                ),
                    ...
                    child: BackdropFilter(
                      ...
                      child: Container(
                        ...
                        child: ExpandableProgressBar(lightIcon,
                            FeedbackMessage.getLightMessage(light), light),
                      ),
                    ),
                  ),
                ),
                    ...
                    child: BackdropFilter(
                      ...
                      child: Container(
                        ...
                        child: ExpandableProgressBar(loudIcon,
                            FeedbackMessage.getLoudnessMessage(loud), loud),
                      ),
                    ),
                  ),
                ),
                  ...
                  child: ClipRRect(
                    ...
                    child: BackdropFilter(
                      ...
                      child: Container(
                        padding: const EdgeInsets.all(10),
                        color: const Color.fromARGB(255, 18, 131, 162),
                        child: ExpandableProgressBar(
                            humidityIcon,
                            FeedbackMessage.getHumidityMessage(humidity),
                            humidity),
                      ),
                    ),
                  ),
